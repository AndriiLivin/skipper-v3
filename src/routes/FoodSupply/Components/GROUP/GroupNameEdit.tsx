...
export default function GroupNameEdit(props: IGroupNameProps) {
  ...
  const handleClickSave = () => {
    formData.append("newGroupName", inputText);

    submit(formData, {
      method: "post",
      action: `food-groups/${props.groupId}/edit-name`,
    });
    setOpen(false);
  };
