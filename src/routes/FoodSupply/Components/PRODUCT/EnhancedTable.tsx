...
import "../../STYLES/_enhanced-table.scss";

// import { IProduct } from "../../TS_foodSupplyUtiles/foodProducts";
...
export default function EnhancedTable() {
  ...
  const handlerOnSubmit = (newProduct: string) => {
    handlerOnSearch("");
    formData.append("newProduct", newProduct);

    submit(formData, {
      method: "post",
      action: `/food-supply/food-groups/${group.id}/add-element`,
    });
  };
      ...
      <Paper id="enhanced-table">
                        ...
                        <IconButton
                          onClick={() => {
                            if (
                              ...
                              submit(null, {
                                method: "post",
                                action: `/food-supply/food-groups/${group.id}/${row.id}/destroy`,
                              });
                            }
                          }}
                        >
        ...
        <Box id="table-footer">
          ...
          <Form
            id="add-product"
            method="post"
            // добавляем в конец адресной строки add-product
            // action="/food-supply/food-groups/:groupId/add-product"
            action="add-element"
          >
            <MicrophoneInput
              id="pp"
